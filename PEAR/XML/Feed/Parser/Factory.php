<?php
$dirs = "";
require_once $dirs.'Log.php';
require_once $dirs.'Log/null.php';
require_once $dirs.'XML/Feed/Parser/Sanitizer.php';
    ...
    public function determineClass($doc_element, $suppressWarnings = false) 
    {
        ...
        switch (true) { 
            case ($doc_element->namespaceURI == 'http://www.w3.org/2005/Atom'):
                require_once $dirs.'XML/Feed/Parser/Atom.php';
                require_once $dirs.'XML/Feed/Parser/AtomElement.php';
            ...
            case ($doc_element->namespaceURI == 'http://purl.org/rss/1.0/' || 
                ...
                require_once $dirs.'XML/Feed/Parser/RSS1.php';
                require_once $dirs.'XML/Feed/Parser/RSS1Element.php';
            ...
            case ($doc_element->namespaceURI == 'http://purl.org/rss/1.1/' || 
                ...
                require_once $dirs.'XML/Feed/Parser/RSS11.php';
                require_once $dirs.'XML/Feed/Parser/RSS11Element.php';
            ...
            case (($doc_element->hasChildNodes() && $doc_element->childNodes->length > 1
                ...
                require_once $dirs.'XML/Feed/Parser/RSS09.php';
                require_once $dirs.'XML/Feed/Parser/RSS09Element.php';
            ...
            case ($doc_element->tagName == 'rss' and
                ...
                require_once $dirs.'XML/Feed/Parser/RSS2.php';
                require_once $dirs.'XML/Feed/Parser/RSS2Element.php';
